...
@JsonSerializable()
class FindResponse extends Object {
  ...
  FindResponse(this.data,this.errorCode,this.errorMsg,);

  factory FindResponse.fromJson(Map<String, dynamic> srcJson) => _$FindResponseFromJson(srcJson);
